#
#  Be sure to run `pod spec lint Palette.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/Charlisim/Palette-iOS.git", :tag => "1.0.1" }
  ...
  s.source_files  = "Palette/*.{h,m,swift}"
